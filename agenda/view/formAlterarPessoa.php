...
<body>
    ...
    <div class="container">
            <form action="../controller/alterarPessoaController.php" method="post">
                ...
                <input type="radio" id="Prefiro não informar" name="cd_sexo" value="Prefiro não informar">
                <br>
                <label for="html">Prefiro não informar</label><br>
                <br>

                <label for="">Data de nascimento</label>
                <input type="date" name="dt_nasc" id="dt_nasc" placeholder="Data de Nascimento" value="<?php echo $pessoa['dt_nasc'] ?>">
                <br>
